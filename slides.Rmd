...
planet. No other single species is able to do this. So what are the
explanations for why humans are so good at adaptive problem solving?

One answer to this question is that we evolved specialized intelligences. On
this view, we are effective problem solvers because our brains evolved so that
individuals could be smart and solve different kinds of problems on their own.
...
inheritance gives you is a head start or shortcut to individual learning.
-->

# Variable acquisition costs[^var]
...
<!--
There is some evidence to think that cultural inheritance should not accumulate
indefinitely. The main reason is that each new generation has more to learn.
Here's a figure showing the relationship between when a mathematical concept
was originally discovered and the age at which that concept is conventionally
learned. The basic idea is that masters students in mathematics, in their early
20s, are still learning ideas that may be over 100 years old.

If these variable acquisition costs constrain culutural accumulation, than we
might expect the benefits of cultural inheritance to diminish over generations.
Cultural inheritance may give a head start in the short run, but eventually
it has a diminishing return, and may not be helpful anymore.
-->

# How much of a head start can be given to future generations?
...
<!--
The purpose of my research was to better understand this question: how much
of a head start can be given to future generations?
